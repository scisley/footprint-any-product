...
materials_agent_prompt_text = get_prompt('materials_agent_prompt')

async def materials_phase(state: FootprintState, config: dict):
    """
    Analyzes the materials phase of the product.
    """
